        ...
        public static object BuildJSONConfiguration(this Configuration config) => new object[]
            {
                ...
                new
                {
                    ...
                    values = new object[]
                    {
                        new { name = nameof(config.EnableTurnstileMode).ToLower(), label = "Ligar turnstile para novos utilizadores", value = config.EnableTurnstileMode },
                        new { name = nameof(config.TurnstileTitle).ToLower(), label = "Título turnstile", value = config.TurnstileTitle },
                        new { name = nameof(config.TurnstilePublicKey).ToLower(), label = "Chave pública turnstile", value = config.TurnstilePublicKey },
                        new { name = nameof(config.TurnstileSecretKeyNotMapped).ToLower(), label = "Chave privada turnstile", value = config.TurnstileSecretKey },
                    }
                }
            };
    }
